...
const LOCAL_ANALYSIS_PROMPT = `Context: "{CONTEXT}". Choose easy to understand definition. 1 consise sentence, not too specific, 18+. Do not repeat phrases from the selected chunk. Give a definition ONLY to the selected chunk. Selected chunk: "{SELECTED_TEXT}".`;
